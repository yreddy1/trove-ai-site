(() => {
  ...
  function generateResponse(input) {
    ...
    if (/\b(home|start|main page|overview|lexso|what is trove|what is lexso|landing|welcome)\b/.test(lower)) {
      return { navigate_to: 'home', message: 'Here is a quick overview of Trove and LEXSO. Taking you to the home page now.' };
    }
